...
const CartProvider = ({children}) =>{
    ...
    return(
        <CartContext.Provider value={{cart, setCart, addItem, removeItem, clearCart, countItemsCart, totalPrice,orderGenerated,setOrderGenerated,cartLS, setCartLS,loadLocalStorage}}>
                {children}
